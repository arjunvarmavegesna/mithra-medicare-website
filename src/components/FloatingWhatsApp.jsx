...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 bg-green-500 text-white pl-4 pr-5 py-3 rounded-full shadow-2xl hover:bg-green-600 transition-colors flex items-center gap-2"
    >
